<?php
    ...
    // 初始化表单变量，防止 undefined variable 警告
    $show_name = $show_foreign_name = $show_cast = '';
    $show_poster_horizontal = $show_poster_vertical = '';
    $show_issuing_company = $show_city = $show_place = '';
    $show_abstract = $show_detail = '';
?>
...
<body>
    <main>
        ...
        <div class="contentflow">
            <div class="noticepad">
                <h1></h1>
                <a>管理员 <?php echo $admin_name;?>，您可以在本页面新增演出。</a></br>
                <a>要登出系统，请返回仪表盘。</a></br>
            </div>
            <?php
                //找人
